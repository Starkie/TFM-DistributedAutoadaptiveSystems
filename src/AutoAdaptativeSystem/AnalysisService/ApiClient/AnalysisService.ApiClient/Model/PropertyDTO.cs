...
using FileParameter = AnalysisService.ApiClient.Client.FileParameter;
using OpenAPIDateConverter = AnalysisService.ApiClient.Client.OpenAPIDateConverter;

namespace AnalysisService.ApiClient.Model
{
    /// <summary>
    /// PropertyDTO
    /// </summary>
