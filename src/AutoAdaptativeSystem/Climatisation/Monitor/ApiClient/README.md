# Climatisation.Monitor.Service.ApiClient - the C# library for the Room Monitor Service
...
```
nuget pack -Build -OutputDirectory out Climatisation.Monitor.Service.ApiClient.csproj
```
