# Knowledge.Service.ApiClient.Api.ServiceApi
...
namespace Example
{
    public class ServiceGetExample
    {
        public static void Main()
        {
            ...
            {
                // Gets all the service configuration properties registered in the knowledge.
                Dictionary<string, Dictionary<string, ConfigurationDTO>> result = apiInstance.ServiceGet();
...
**Dictionary<string, Dictionary<string, ConfigurationDTO>>**
