...
using FileParameter = Monitoring.Service.ApiClient.Client.FileParameter;
using OpenAPIDateConverter = Monitoring.Service.ApiClient.Client.OpenAPIDateConverter;

namespace Monitoring.Service.ApiClient.Model
{
    /// <summary>
    /// PropertyDTO
    /// </summary>
