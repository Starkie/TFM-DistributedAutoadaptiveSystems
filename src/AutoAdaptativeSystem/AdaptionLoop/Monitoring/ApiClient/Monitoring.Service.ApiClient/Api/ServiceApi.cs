...
namespace Monitoring.Service.ApiClient.Api
{
    ...
    public partial class ServiceApi : IDisposable, IServiceApi
    {
        ...
        /// <param name="setPropertyDTO">The collection of properties to set. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Monitoring.Service.ApiClient.Client.ApiResponse<Object> ServiceServiceNameConfigurationPutWithHttpInfo(string serviceName, List<SetPropertyDTO>? setPropertyDTO = default(List<SetPropertyDTO>?))
        {
            // verify the required parameter 'serviceName' is set
            if (serviceName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'serviceName' when calling ServiceApi->ServiceServiceNameConfigurationPut");
