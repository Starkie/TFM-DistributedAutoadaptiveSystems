...
namespace Monitoring.Service.ApiClient.Api
{
    ...
    public interface IServiceApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <exception cref="Monitoring.Service.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Monitoring.Service.ApiClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Monitoring.Service.ApiClient.Client.Configuration.MergeConfigurations(
                Monitoring.Service.ApiClient.Client.GlobalConfiguration.Instance,
                new Monitoring.Service.ApiClient.Client.Configuration { BasePath = basePath }
            );
            this.ApiClient = new Monitoring.Service.ApiClient.Client.ApiClient(this.Configuration.BasePath);
            this.Client =  this.ApiClient;
            this.AsynchronousClient = this.ApiClient;
            this.ExceptionFactory = Monitoring.Service.ApiClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public ServiceApi(Monitoring.Service.ApiClient.Client.Configuration configuration)
        {
            ...
            this.Client = this.ApiClient;
            this.AsynchronousClient = this.ApiClient;
            ExceptionFactory = Monitoring.Service.ApiClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public ServiceApi(HttpClient client, string basePath, HttpClientHandler handler = null)
        {
            ...
            this.ApiClient = new Monitoring.Service.ApiClient.Client.ApiClient(client, this.Configuration.BasePath, handler);
            this.Client =  this.ApiClient;
            this.AsynchronousClient = this.ApiClient;
            this.ExceptionFactory = Monitoring.Service.ApiClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ServiceApi(HttpClient client, Monitoring.Service.ApiClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ServiceApi(Monitoring.Service.ApiClient.Client.ISynchronousClient client, Monitoring.Service.ApiClient.Client.IAsynchronousClient asyncClient, Monitoring.Service.ApiClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// </summary>
        public Monitoring.Service.ApiClient.Client.ApiClient ApiClient { get; set; } = null;

        /// <summary>
        /// The client for accessing this underlying API asynchronously.
        /// </summary>
        public Monitoring.Service.ApiClient.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Monitoring.Service.ApiClient.Client.ISynchronousClient Client { get; set; }
        ...
        public Monitoring.Service.ApiClient.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Monitoring.Service.ApiClient.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Monitoring.Service.ApiClient.Client.ApiResponse<ConfigurationDTO> localVarResponse = ServiceServiceNameConfigurationConfigurationNameGetWithHttpInfo(serviceName, configurationName);
        ...
        /// <param name="configurationName">The name of the configuration property to find.</param>
        /// <returns>ApiResponse of ConfigurationDTO</returns>
        public Monitoring.Service.ApiClient.Client.ApiResponse<ConfigurationDTO> ServiceServiceNameConfigurationConfigurationNameGetWithHttpInfo(string serviceName, string configurationName)
        {
            // verify the required parameter 'serviceName' is set
            if (serviceName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'serviceName' when calling ServiceApi->ServiceServiceNameConfigurationConfigurationNameGet");

            // verify the required parameter 'configurationName' is set
            if (configurationName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'configurationName' when calling ServiceApi->ServiceServiceNameConfigurationConfigurationNameGet");

            Monitoring.Service.ApiClient.Client.RequestOptions localVarRequestOptions = new Monitoring.Service.ApiClient.Client.RequestOptions();
            ...
            var localVarContentType = Monitoring.Service.ApiClient.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null) localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);

            var localVarAccept = Monitoring.Service.ApiClient.Client.ClientUtils.SelectHeaderAccept(_accepts);
            if (localVarAccept != null) localVarRequestOptions.HeaderParameters.Add("Accept", localVarAccept);

            localVarRequestOptions.PathParameters.Add("serviceName", Monitoring.Service.ApiClient.Client.ClientUtils.ParameterToString(serviceName)); // path parameter
            localVarRequestOptions.PathParameters.Add("configurationName", Monitoring.Service.ApiClient.Client.ClientUtils.ParameterToString(configurationName)); // path parameter
        ...
        {
            Monitoring.Service.ApiClient.Client.ApiResponse<ConfigurationDTO> localVarResponse = await ServiceServiceNameConfigurationConfigurationNameGetWithHttpInfoAsync(serviceName, configurationName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ConfigurationDTO)</returns>
        public async System.Threading.Tasks.Task<Monitoring.Service.ApiClient.Client.ApiResponse<ConfigurationDTO>> ServiceServiceNameConfigurationConfigurationNameGetWithHttpInfoAsync(string serviceName, string configurationName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'serviceName' is set
            if (serviceName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'serviceName' when calling ServiceApi->ServiceServiceNameConfigurationConfigurationNameGet");
        ...
        /// <param name="setPropertyDTO">The DTO containing the value to set. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Monitoring.Service.ApiClient.Client.ApiResponse<Object> ServiceServiceNameConfigurationConfigurationNamePutWithHttpInfo(string serviceName, string configurationName, SetPropertyDTO? setPropertyDTO = default(SetPropertyDTO?))
        {
            // verify the required parameter 'serviceName' is set
            if (serviceName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'serviceName' when calling ServiceApi->ServiceServiceNameConfigurationConfigurationNamePut");

            // verify the required parameter 'configurationName' is set
            if (configurationName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'configurationName' when calling ServiceApi->ServiceServiceNameConfigurationConfigurationNamePut");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Monitoring.Service.ApiClient.Client.ApiResponse<Object>> ServiceServiceNameConfigurationConfigurationNamePutWithHttpInfoAsync(string serviceName, string configurationName, SetPropertyDTO? setPropertyDTO = default(SetPropertyDTO?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'serviceName' is set
            if (serviceName == null)
                throw new Monitoring.Service.ApiClient.Client.ApiException(400, "Missing required parameter 'serviceName' when calling ServiceApi->ServiceServiceNameConfigurationConfigurationNamePut");
