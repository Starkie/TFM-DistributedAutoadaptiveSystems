...
namespace MonitoringService.ApiClient.Api
{
    ...
    public partial class PropertyApi : IDisposable, IPropertyApi
    {
        ...
        /// <returns></returns>
        public PropertyApi(MonitoringService.ApiClient.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public PropertyApi(HttpClient client, MonitoringService.ApiClient.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public PropertyApi(MonitoringService.ApiClient.Client.ISynchronousClient client, MonitoringService.ApiClient.Client.IAsynchronousClient asyncClient, MonitoringService.ApiClient.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            MonitoringService.ApiClient.Client.ApiResponse<PropertyDTO> localVarResponse = PropertyPropertyNameGetWithHttpInfo(propertyName);
        ...
        /// <param name="propertyName">The name of the property to look for.</param>
        /// <returns>ApiResponse of PropertyDTO</returns>
        public MonitoringService.ApiClient.Client.ApiResponse<PropertyDTO> PropertyPropertyNameGetWithHttpInfo(string propertyName)
        {
            // verify the required parameter 'propertyName' is set
            if (propertyName == null)
                throw new MonitoringService.ApiClient.Client.ApiException(400, "Missing required parameter 'propertyName' when calling PropertyApi->PropertyPropertyNameGet");
            ...
            localVarRequestOptions.PathParameters.Add("propertyName", MonitoringService.ApiClient.Client.ClientUtils.ParameterToString(propertyName)); // path parameter
        ...
        {
            MonitoringService.ApiClient.Client.ApiResponse<PropertyDTO> localVarResponse = await PropertyPropertyNameGetWithHttpInfoAsync(propertyName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PropertyDTO)</returns>
        public async System.Threading.Tasks.Task<MonitoringService.ApiClient.Client.ApiResponse<PropertyDTO>> PropertyPropertyNameGetWithHttpInfoAsync(string propertyName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'propertyName' is set
            if (propertyName == null)
                throw new MonitoringService.ApiClient.Client.ApiException(400, "Missing required parameter 'propertyName' when calling PropertyApi->PropertyPropertyNameGet");
