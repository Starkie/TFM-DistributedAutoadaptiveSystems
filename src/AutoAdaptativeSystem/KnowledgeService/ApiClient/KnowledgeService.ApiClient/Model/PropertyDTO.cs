...
using FileParameter = KnowledgeService.ApiClient.Client.FileParameter;
using OpenAPIDateConverter = KnowledgeService.ApiClient.Client.OpenAPIDateConverter;

namespace KnowledgeService.ApiClient.Model
{
    /// <summary>
    /// PropertyDTO
    /// </summary>
