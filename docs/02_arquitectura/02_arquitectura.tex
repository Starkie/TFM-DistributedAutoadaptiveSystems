...
\begin{itemize}
  \item \textbf{GET} property/\{\textit{propertyName}\}: Devuelve el valor de la propiedad, si existe.  Devuelve un DTO que contiene el valor de la propiedad, serializado en JSON, y la fecha y hora de la última modificación.
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.65]{02_arquitectura/images/Monitor-Knowledge-Connector}
