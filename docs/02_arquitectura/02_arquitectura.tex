...
A continuación vamos a demostrar cómo utilizamos OpenAPI para documentar nuestra API y generar la especificación y el cliente a partir de esta. Para ello, continuaremos con el ejemplo del servicio de conocimiento que hemos descrito a lo largo de este capítulo. Vamos a centrarnos en la implementación de la operación para obtener una propiedad del conocimiento, que describimos en la tabla \ref{tab:especificacion-get-property}.
...
Después, haciendo uso de las librerías de OpenAPI, generamos la especificación a partir del servicio de conocimiento. En el \textcolor{red}{fragmento} \ref{ls:openapi-get}, podemos ver cómo se describe la operación. Encontramos grandes similitudes con la presentada en la tabla \ref{tab:especificacion-get-property}.
