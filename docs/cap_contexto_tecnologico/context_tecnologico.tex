...
En el caso del servicio web, la acción correspondiente sería desplegar una nueva instancia. El efector conocerá el sistema de despliegue (p.e. Docker) y cómo solicitar la activación de un nuevo servicio.
