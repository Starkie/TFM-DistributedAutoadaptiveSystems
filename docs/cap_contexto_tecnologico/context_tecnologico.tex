...
Los \textbf{efectores} son el segundo tipo de \foreign{english}{touchpoint} que debe implementar el recurso manejado. Son aquellos que al bucle modificar su configuración o estado.  Pueden implementarse de distintas formas: mediante ficheros de configuración, comandos, \emph{endpoints} HTTP, etc.
...
Si nos fijamos en la figura \ref{fig:autonomic-element}, veremos que en la parte superior del elemento autónomo figuran sondas y efectores. Esto nos indica que a su vez, pueden actuar también como recursos manejados. Esto nos permite poner por encima de este otro manejador autónomo que actúe como un \textbf{orquestador}. \cite{ibmcorporationArchitecturalBlueprintAutonomic2006}. Estos gestionan a un nivel superior uno o más elementos autonómicos. Son por tanto, elementos componibles.

Este orquestador podría estar responsabilizado de otras tareas de más alto nivel. Como el balanceo de carga o cosas por el estilo.

Por encima de estos orquestadores, finalmente, tendríamos al administrador u operario humano. 
