...
Una vez definidos los componentes y sus conectores, podemos mostrar el diseño final de nuestra arquitectura. Las APIs que expondrá cada microservicio las describimos en detalle en el anexo \ref{anx:apis} - \nameref{anx:apis}.
