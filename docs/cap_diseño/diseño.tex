...
\begin{figure}[htb]
  \centering
  \includegraphics[scale=0.75]{cap_diseño/images/Monitor-Knowledge-Connector}
...
\begin{wrapfigure}{l}{0.38\linewidth}
  \centering
  \includegraphics[scale=0.50]{cap_diseño/images/Knowledge-Analysis-Initial-Notification-Connector}
...
Para estudiarla, tomamos como ejemplo la comunicación entre el servicio de conocimiento y los aquellos en el nivel del bucle. Cada vez que se modifique una propiedad de adaptación o una clave de configuración, emitirá una notificación a la capa superior. Así, por ejemplo, el servicio de análisis sabrá que debe evaluar las reglas de adaptación.
...
Para implementar este patrón, nuestro conector estará compuesto por tres elementos: un \textbf{publicador}, el \textbf{\foreign{english}{broker}} y un \textbf{consumidor}. Pongamos por ejemplo que el servicio de conocimiento recibe una petición para actualizar una propiedad. Si esta actualización se lleva a cabo, deberá propagar el evento a través del publicador. Este enviará el mensaje al \foreign{english}{broker} a un \foreign{english}{exchange} determinado.
...
\begin{figure}[htb]
  ...
  \caption{Diseño del conector para notificaciones mediante un \foreign{english}{broker} de mensajería.}
