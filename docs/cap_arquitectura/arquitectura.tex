...
Este capitulo es relevante por dos motivos:

\begin{itemize}
  \item En el trabajo tratamos la migración de un sistema monolítico a uno basado en microservicios. Trabajamos con conceptos como los componentes, los conectores software y otros elementos arquitectónicos. Por tanto es conveniente contar con este marco teórico.

  \item Por otro lado, nuestro bucle MAPE-K es capaz de cambiar la arquitectura del recurso manejado en tiempo de ejecución. Sus adaptaciones se describen en base a operadores arquitectónicos que las modifican. Por tanto el interés es doble.
\end{itemize}
