...
La regla base está implementada según el patrón plantilla (o \foreign{english}{template})\footnote{\url{https://refactoring.guru/design-patterns/template-method}}. Estas reglas afectadas se evaluarán para determinar si es necesario ejecutarse (línea 11). Si es así, se ejecutarán ()
