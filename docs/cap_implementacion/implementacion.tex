...
Una vez se publica el mensaje en el bus, el consumidor, que está suscrito al al mismo en el message queue. Y hará d que está suscrito al mismo, lo capturara.
